...
export default function LandingPage() {
  ...
  // Hero scramble on total tool count
  const [heroCount, setHeroCount] = useState(builtTools.length.toString())
  useEffect(() => {
    ...
    const t = setInterval(() => {
      ...
      runs++
      if (runs > 12) { clearInterval(t); setHeroCount(builtTools.length.toString()) }
    }, 60)
    return () => clearInterval(t)
  }, [heroVisible, builtTools.length])
  ...
  return (
    <div className="bg-[#000000] text-[#F9F9F9] min-h-screen overflow-x-hidden">
      ...
      >
        ...
        >
          <StatBlock label="Developer Tools" value={builtTools.length} active={statsVisible} />
